...
本章阐述了当一个验证尝试发生时 Shiro 主要的工作流程，而在验证过程中，用到的 Realm 内产生的工作流程（如上面提到的第5步）将在 [Realm](http://shiro.apache.org/realm.html) 章中 [Realm Authentication](http://shiro.apache.org/realm.html#Realm-authentication) 节讨论。
